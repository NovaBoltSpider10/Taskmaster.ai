...
const Classes = () => {
  ...
  return (
    <div className="min-h-screen w-full p-6 space-y-6 bg-gradient-to-br from-skyLightest via-white to-skyLightest dark:from-[#181825] dark:via-[#1e1e2e] dark:to-[#181825] text-gray-900 dark:text-darkText transition">
      {/* Toast */}
      {toast.show && (
        <div
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        <div className="bg-white dark:bg-darkCard rounded-lg p-6 shadow-md border border-gray-200 dark:border-gray-700">
          ...
          >
            <p className="text-gray-600 dark:text-gray-300">Drag or click to select a file</p>
            <input
              id="file"
              type="file"
              {...register("file")}
