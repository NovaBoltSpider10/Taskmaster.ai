...
const Resources = () => {
  ...
  return (
    <div className="p-4 bg-skyLightest dark:bg-darkBg text-gray-800 dark:text-darkText min-h-screen transition">
      <h2 className="text-2xl font-bold mb-4 text-center dark:text-white">Your Class Resources</h2>
      {userClasses.length === 0 ? (
        <p className="text-center text-gray-600 dark:text-gray-400">No classes found for your account.</p>
      ) : (
                ...
                {res && res.urls.length > 0 ? (
                  <div>
                    ...
                    <div className="space-y-1">
                      {res.urls.map((url, i) => (
                        <div key={i} className="border-b border-gray-300 dark:border-gray-600 pb-1">
                          <a
                            href={url}
                            target="_blank"
